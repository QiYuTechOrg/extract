...
import {FnExecArgsV2, FnExecResult, FnQueueUrl} from "../../shared/dt_core";

export async function fn(args: FnExecArgsV2<Record<string, never>, Record<string, any>>): Promise<FnExecResult> {
    /// 检测是否为 腾讯新闻页面
